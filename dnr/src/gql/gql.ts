...
const documents = {
    ...
    "query GetTickData($poolId: ID!, $tickId: Bytes!, $account: Bytes!) {\n  pool(id: $poolId) {\n    id\n    collateralToken {\n      name\n    }\n    currencyToken {\n      symbol\n    }\n    ticks(where: {id: $tickId}) {\n      limit\n      duration\n      rate\n      raw\n    }\n    deposits(where: {account: $account}) {\n      depositedAmount\n      shares\n      tick {\n        id\n      }\n    }\n  }\n}": types.GetTickDataDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetTickData($poolId: ID!, $tickId: Bytes!, $account: Bytes!) {\n  pool(id: $poolId) {\n    id\n    collateralToken {\n      name\n    }\n    currencyToken {\n      symbol\n    }\n    ticks(where: {id: $tickId}) {\n      limit\n      duration\n      rate\n      raw\n    }\n    deposits(where: {account: $account}) {\n      depositedAmount\n      shares\n      tick {\n        id\n      }\n    }\n  }\n}"): (typeof documents)["query GetTickData($poolId: ID!, $tickId: Bytes!, $account: Bytes!) {\n  pool(id: $poolId) {\n    id\n    collateralToken {\n      name\n    }\n    currencyToken {\n      symbol\n    }\n    ticks(where: {id: $tickId}) {\n      limit\n      duration\n      rate\n      raw\n    }\n    deposits(where: {account: $account}) {\n      depositedAmount\n      shares\n      tick {\n        id\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
