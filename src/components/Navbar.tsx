...
export const Navbar = () => {
  ...
  return (
    <nav className="z-10 w-full items-center justify-between font-mono text-sm lg:flex mb-16 max-w-5xl mx-auto bg-indigo-400/10 backdrop-blur-sm p-3 rounded-xl">
